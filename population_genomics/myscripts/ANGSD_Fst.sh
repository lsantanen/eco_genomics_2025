...
#SBATCH --output=/users/l/s/lsantane/projects/eco_genomics_2025/population_genomics/mylogs/%x_%j.out
...
# this script will use ANGSD to estimate Fst betweeen my red spruce pop
#and black spruce from outside the range

# Path to the `population_genomics` folder in your repo

REPO="/users/l/s/lsantane/projects/eco_genomics_2025/population_genomics"
