...
countsTable <- read.table("/users/l/s/lsantane/projects/eco_genomics_2025/transcriptomics/mydata/counts_matrix.txt", header=TRUE, row.names=1)
dim(countsTable)
...
conds <- read.delim("/users/l/s/lsantane/projects/eco_genomics_2025/transcriptomics/mydata/metadata.txt", header=TRUE, stringsAsFactors = TRUE, row.names=1)
