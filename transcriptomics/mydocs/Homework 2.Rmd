...
```{r}
pdf("GO_Enrichment_AllGen.pdf",width=100,height=100)
par(mfrow=c(2,2))
...
plot1 <- ggplot(G1G2merged, aes(x = G1_LFC, y = G2_LFC)) +
  theme_minimal(base_size = 10) +
  ggtitle("LFC DEGs G1 vs G2") +
  xlab("G1_LFC") +
  ylab("G2_LFC") +
...
plot2 <- ggplot(G2G1merged, aes(x = G2_LFC, y = G1_LFC)) +
  theme_minimal(base_size = 10) +
  ggtitle("LFC DEGs G2 vs G1") +
  xlab("G2_LFC") +
  ylab("G1_LFC") +
...
ggsave("LFC.pdf",width=8,height=4)
