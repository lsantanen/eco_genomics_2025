...
######
G1_GOenrich = res_table[which(res_table$classicFisher<0.05),"GO.ID"]
...
# Merge with GO annotations
tonsa_stat <- merge(res_G3_GO_sig, tonsa_go, by = "geneID")
...
# Merge with GO annotations
tonsa_stat <- merge(res_G4_GO_sig, tonsa_go, by = "geneID")
